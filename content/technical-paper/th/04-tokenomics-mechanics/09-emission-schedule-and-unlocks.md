...
- **Airdrop** — ปล่อยเป็นแคมเปญหลายช่วงเวลา ไม่ใช่เหตุการณ์เดียว สำหรับแต่ละการกระจาย ชุดผู้รับและวิธีคำนวณจะถูกผูกไว้บนบล็อกเชนก่อนโทเค็นเคลื่อนย้าย แต่ละส่วนเคลมได้โดยไม่มี vesting ผ่านตัวกระจายเฉพาะที่แยกจากการชำระรางวัลผู้ใช้รายสัปดาห์ ขนาดการกระจายเผยแพร่ในบันทึกของแคมเปญนั้น
...
- **กำหนดการปล่อยพูล Staking** ระบุปริมาณการปล่อยและระยะเวลาของพูล staking ตามที่เผยแพร่ไว้
