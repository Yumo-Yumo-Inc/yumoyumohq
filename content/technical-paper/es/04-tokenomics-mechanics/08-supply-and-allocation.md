...
- **Airdrop** — distribuido a lo largo de múltiples periodos como campañas. Para cada distribución, el conjunto de destinatarios y el método de cálculo se comprometen en cadena antes de mover los tokens. El dimensionamiento se publica en el registro de la campaña correspondiente.
