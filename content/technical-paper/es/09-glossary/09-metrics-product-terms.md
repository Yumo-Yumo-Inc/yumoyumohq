# Métricas y términos de producto

## Métricas y términos de producto

- **MAU** — Usuarios Activos Mensuales. El denominador para la banda de escalamiento de la curva de emisión. *Véase: 04.*
- **Receipt** — En Yumo Yumo, un documento que representa un gasto del hogar. Recibos de venta minorista en papel, facturas electrónicas y confirmaciones de pedido caen en este alcance.
