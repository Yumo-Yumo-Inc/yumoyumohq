...
| Libro mayor y contabilidad de recompensas | Mantener eventos bINT como un flujo contable inmutable | Modelo de eventos de solo adición (append-only), registros de liquidación auditables |
