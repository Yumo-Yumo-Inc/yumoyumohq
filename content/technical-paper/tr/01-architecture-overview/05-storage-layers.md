...
|---|---|---|---|---|
| Kayıt katmanı | Fiş kayıtları, satır kalemleri, aşama olayları | Uygulama veritabanı (tek bir yönetilen Postgres) | Aktif ürün penceresi | Takma adlı |
| Analitik katman | Normalize gözlemler ve kalite metrikleri | Uygulama veritabanında ayrılmış tablolar | Politika tanımlı yuvarlanan pencere | Takma adlı veya anonim |
