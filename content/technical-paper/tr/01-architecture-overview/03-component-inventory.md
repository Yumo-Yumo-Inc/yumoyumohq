...
|---|---|---|
| İstemci uygulaması | Fiş yakalama, cüzdan imzası, kullanıcıya önizleme gösterimi | Kullanıcı imzalaması cihaz tarafında gerçekleşir; yükleme açık kullanıcı aksiyonuyla başlar |
...
| Defter ve ödül muhasebesi | bINT olaylarını değiştirilemez muhasebe akışı olarak tutma | Yalnız-ekleme olay modeli, denetlenebilir mutabakat kayıtları |
| Veri ürünü katmanı | Fiş gözlemlerinden anonimleştirilmiş toplamlar üretme | Kişisel veriden ayrıştırılmış, k-eşikli ve sürümlenmiş toplam çıktılar |
