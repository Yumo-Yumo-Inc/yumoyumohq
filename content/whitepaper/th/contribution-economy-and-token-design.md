...
| **bINT** | หน่วยบัญชีนอกเชน (ชั้นปฏิบัติการ) | ไม่ได้ — ชำระเป็น INT ผ่านวงจรชีวิตที่กำหนดไว้ | บัญชีการมีส่วนร่วม ชั้นนุ่มระหว่างงานกับรางวัล |
...
ก่อน Token Generation Event แพลตฟอร์มติดตามการมีส่วนร่วมผ่าน cPoints การวัดชื่อเสียงในระบบปิด cPoints มีอยู่เฉพาะในระยะก่อน TGE บอกน้ำหนัก airdrop เริ่มต้นและน้ำหนัก onboarding ที่ TGE จากนั้นเลิกใช้งาน ตั้งแต่ TGE เป็นต้นไป ชั้น bINT แทนที่บทบาทของ cPoints ด้วยความหมายของการมีส่วนร่วมที่แข็งแกร่งกว่า
