...
type QuestFrequency = "daily" | "weekly" | "monthly" | "streak" | "event";
...
export type DailyDiscoveryType = "DD1" | "DD2" | "DD3" | "DD4" | "DD5" | "DD6" | "DD7" | "DD8" | "DD9" | "DD10"
  // Fun / easter-egg quests (receipt-signal based, see update-progress-on-receipt.ts)
...
type AnyQuestType = DailyQuestType | WeeklyQuestType;

// ── Legacy exports (backward compat) ─────────────────────
const DAILY_QUEST_TYPES: DailyReceiptType[] = ["D1", "D3", "D4", "D5", "D6", "D7", "D8", "D9"];
const WEEKLY_QUEST_TYPES: WeeklyReceiptType[] = ["W1A", "W1B", "W1C", "W2", "W3", "W4", "W5", "W6"];

// ── All type arrays by tier ───────────────────────────────
const ALL_DAILY_RECEIPT: DailyReceiptType[] = [
  "D1", "D3", "D4", "D5", "D6", "D7", "D8", "D9",
  "D10", "D11", "D12", "D13", "D14", "D16",
];
const ALL_WEEKLY_RECEIPT: WeeklyReceiptType[] = [
  "W1A", "W1B", "W1C", "W2", "W3", "W4", "W5", "W6",
  "W7", "W8", "W9", "W10", "W11", "W12",
];
const ALL_DAILY_DISCOVERY: DailyDiscoveryType[] = [
  "DD1", "DD2", "DD3", "DD4", "DD5", "DD6", "DD7", "DD8", "DD9", "DD10",
  "DD11", "DD12", "DD13", "DD14", "DD15", "DD16", "DD17", "DD18",
];
const ALL_WEEKLY_DISCOVERY: WeeklyDiscoveryType[] = [
  "WD1", "WD2", "WD3", "WD4", "WD5", "WD6", "WD7", "WD8",
];
const ALL_DAILY_SAVINGS: DailySavingsType[] = [
  "DS1", "DS2", "DS3", "DS4", "DS5", "DS6", "DS7", "DS8",
];
const ALL_WEEKLY_SAVINGS: WeeklySavingsType[] = [
  "WS1", "WS2", "WS3", "WS4", "WS5", "WS6",
];
const ALL_DAILY_SOCIAL: DailySocialType[] = [
  "DC1", "DC2", "DC3", "DC4", "DC5", "DC6",
];
const ALL_WEEKLY_SOCIAL: WeeklySocialType[] = [
  "WC1", "WC2", "WC3", "WC4", "WC5", "WC6", "WC7", "WC8",
];

// ── Combined arrays ───────────────────────────────────────
const ALL_DAILY_TYPES: DailyQuestType[] = [
